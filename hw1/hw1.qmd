...
Replace the incredible zeroes in other variables with the missing value code. Fit a model with the result of the diabetes test as the response and all the other variables as predictors. How many observations were used in the model fitting? Why is this less than the number of observations in the data frame. (10pts)
 ...
 Min.   : 0.000   Min.   :  0.0   Min.   :  0.00   Min.   : 0.00   Min.   : 14.00   Min.   : 0.00   Min.   :0.0780  
 1st Qu.: 1.000   1st Qu.: 99.0   1st Qu.: 62.00   1st Qu.: 0.00   1st Qu.: 76.25   1st Qu.:27.30   1st Qu.:0.2437  
 Median : 3.000   Median :117.0   Median : 72.00   Median :23.00   Median :125.00   Median :32.00   Median :0.3725  
 Mean   : 3.845   Mean   :120.9   Mean   : 69.11   Mean   :20.54   Mean   :155.55   Mean   :31.99   Mean   :0.4719  
 3rd Qu.: 6.000   3rd Qu.:140.2   3rd Qu.: 80.00   3rd Qu.:32.00   3rd Qu.:190.00   3rd Qu.:36.60   3rd Qu.:0.6262  
 Max.   :17.000   Max.   :199.0   Max.   :122.00   Max.   :99.00   Max.   :846.00   Max.   :67.10   Max.   :2.4200  
                                                                   NA's   :374                                      
      age              test    
 Min.   :21.00   Negative:500  
 1st Qu.:24.00   Positive:268  
 Median :29.00                 
 Mean   :33.24                 
 3rd Qu.:41.00                 
 Max.   :81.00                 
...
**Solution ** 
We are able to see the results of the code: summary(pima) that all the following predictor variables have entries "0" as the minimum: pregnant, glucose, diastolic, triceps, and bmi. 

```{r}
variables <- c("glucose", "diastolic", "triceps", "insulin", "bmi", "diabetes")
