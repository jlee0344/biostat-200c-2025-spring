...
**1. Binary Outcome: ** The dependent variable should be binary (Example: Death = 1/0). 
**2. Independence of Observations: ** The observations (counties) should be independent. 
**3. Linearity of Logit (No Severe Confounding) **: 
